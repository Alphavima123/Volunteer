...
public class DonorLoginPage3_3
{
	...
	public DonorLoginPage3_3 (WebDriver driver)
	{
		PageFactory.initElements(driver, this);
	}
	
	public void clickDonorLoginPage3_3DNow() {
		DonateNow.click();	
	}
	public void clickDonorLoginPage3_3DAmount() {
		DonateAmount.click();	
	}
	public void clickDonorLoginPage3_3Next() {
		Next.click();
	}
	public void clickDonorLoginPage3_3fund() {
		Fund.click();
	}
	...
	public void clickDonorLoginPage3_3Next2() {
		Next2.click();
	}
	public void setDonorLoginPage3_3Fname(String fname) {
		Fname.sendKeys(fname);
	}
	public void setDonorLoginPage3_3Lname(String lname) {
		Lname.sendKeys(lname);
	}
	
	public void setDonorLoginPage3_3Email(String email) {
		Email.sendKeys(email);
	}
	
	public void setDonorLoginPage3_3pNumber(String phoneno) {
		Phoneno.sendKeys(phoneno);
	}
	public void setDonorLoginPage3_3Birthday() {
		Birthday.sendKeys("12/03/1984");
	}
	public void setDonorLoginPage3_3Address(String adress) {
		Adress.sendKeys(adress);
	}
	public void setDonorLoginPage3_3Address1(String Adress1) {
		Adressline1.sendKeys(Adress1);
	}
	public void setDonorLoginPage3_3Address2(String Adress2) {
		Adressline2.sendKeys(Adress2);
	}
	public void setDonorLoginPage3_3City(String city) {
		City.sendKeys(city);
	}
	public void setDonorLoginPage3_3country(String country) {
		Country.sendKeys(country);
	}
	public void setDonorLoginPage3_3State(String state) {
		State.sendKeys(state);
	}
	public void setDonorLoginPage3_3code(String postalcode) {
		Postalcode.sendKeys(postalcode);
	}
	public void setDonorLoginPage3_3card(String cardno) 
	{
	...
	public void setDonorLoginPage3_3cvv(String cvvNo)
	{
		CardCVV.sendKeys(cvvNo);
	}
	public void clickDonorLoginPage3_3nopublic() {
		NOPublic.click();
	}
	
	public void clickDonorLoginPage3_3Finish() {
		Finish.click();
	}
}
