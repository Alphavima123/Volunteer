...
public class DonorLoginPage3_1
{
	...
	public DonorLoginPage3_1 (WebDriver driver)
	{
		PageFactory.initElements(driver, this);
	}
	
	public void clickDonorLoginPage3_1DNow() {
		DonateNow.click();	
	}
	public void clickDonorLoginPage3_1DAmount() {
		DonateAmount.click();	
	}
	public void clickDonorLoginPage3_1Next() {
		Next.click();
	}
	public void clickDonorLoginPage3_1Cause() {
		Cause.click();
	}
	...
	public void clickDonorLoginPage3_1tgift() {
		Tributegift.click();
	}
	...
	public void setDonorLoginPage3_1Tname(String tname) {
		TributeName.sendKeys(tname);
	}
	public void clickDonorLoginPage3_1Next2() {
		Next2.click();
	}
	public void setDonorLoginPage3_1Fname(String fname) {
		Fname.sendKeys(fname);
	}
	public void setDonorLoginPage3_1Lname(String lname) {
		Lname.sendKeys(lname);
	}
	
	public void setDonorLoginPage3_1Email(String email) {
		Email.sendKeys(email);
	}
	
	public void setDonorLoginPage3_1pNumber(String phoneno) {
		Phoneno.sendKeys(phoneno);
	}
	public void setDonorLoginPage3_1Birthday() {
		Birthday.sendKeys("12/03/1984");
	}
	public void setDonorLoginPage3_1Address(String adress) {
		Adress.sendKeys(adress);
	}
	public void setDonorLoginPage3_1Address1(String Adress1) {
		Adressline1.sendKeys(Adress1);
	}
	public void setDonorLoginPage3_1Address2(String Adress2) {
		Adressline2.sendKeys(Adress2);
	}
	public void setDonorLoginPage3_1City(String city) {
		City.sendKeys(city);
	}
	public void setDonorLoginPage3_1country(String country) {
		Country.sendKeys(country);
	}
	public void setDonorLoginPage3_1State(String state) {
		State.sendKeys(state);
	}
	public void setDonorLoginPage3_1code(String postalcode) {
		Postalcode.sendKeys(postalcode);
	}
	public void setDonorLoginPage3_1card(String cardno) 
	{
	...
	public void setDonorLoginPage3_1cvv(String cvvNo)
	{
		CardCVV.sendKeys(cvvNo);
	}
	public void clickDonorLoginPage3_1Finish() {
		Finish.click();
	}
}
