...
public class DonorLoginPage3
{
	...
	public DonorLoginPage3 (WebDriver driver)
	{
		PageFactory.initElements(driver, this);
	}
	
	public void clickDonorLoginPage3DNow() {
		DonateNow.click();	
	}
	public void clickDonorLoginPage3DAmount() {
		DonateAmount.click();	
	}
	public void clickDonorLoginPage3Next() {
		Next.click();
	}
	public void clickDonorLoginPage3Cause() {
		Cause.click();
	}
	...
	public void clickDonorLoginPage3Next2() {
		Next2.click();
	}
	public void setDonorLoginPage3Fname(String fname) {
		Fname.sendKeys(fname);
	}
	public void setDonorLoginPage3Lname(String lname) {
		Lname.sendKeys(lname);
	}
	
	public void setDonorLoginPage3Email(String email) {
		Email.sendKeys(email);
	}
	
	public void setDonorLoginPage3pNumber(String phoneno) {
		Phoneno.sendKeys(phoneno);
	}
	public void setDonorLoginPage3Birthday() {
		Birthday.sendKeys("12/03/1984");
	}
	public void setDonorLoginPage3Address(String adress) {
		Adress.sendKeys(adress);
	}
	public void setDonorLoginPage3Address1(String Adress1) {
		Adressline1.sendKeys(Adress1);
	}
	public void setDonorLoginPage3Address2(String Adress2) {
		Adressline2.sendKeys(Adress2);
	}
	public void setDonorLoginPage3City(String city) {
		City.sendKeys(city);
	}
	public void setDonorLoginPage3country(String country) {
		Country.sendKeys(country);
	}
	public void setDonorLoginPage3State(String state) {
		State.sendKeys(state);
	}
	public void setDonorLoginPage3code(String postalcode) {
		Postalcode.sendKeys(postalcode);
	}
	public void setDonorLoginPage3card(String cardno) 
	{
	...
	public void setDonorLoginPage3cvv(String cvvNo)
	{
		CardCVV.sendKeys(cvvNo);
	}
	public void clickDonorLoginPage3Finish() {
		Finish.click();
	}
}
