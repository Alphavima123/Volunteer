...
public class FundDevelopmentGrant2 
{
		...
		WebDriver driver=new ChromeDriver();
		 ...
		 driver.findElement(By.xpath("//input[@type='button']")).click();
			...
			for(int i=1;i<=rowcount;i++)
			{
				...
				String NewOrganization = celldata.getCell(19).getStringCellValue();
				String OrganizationPhoneNumber = celldata.getCell(19).getStringCellValue();
				String Email1 = celldata.getCell(19).getStringCellValue();
				String Address = celldata.getCell(19).getStringCellValue();
				String Apartment = celldata.getCell(19).getStringCellValue();
				String Street = celldata.getCell(19).getStringCellValue();
				String City = celldata.getCell(19).getStringCellValue();
				String State = celldata.getCell(19).getStringCellValue();
				String PostalCode = celldata.getCell(19).getStringCellValue();
				String Country = celldata.getCell(19).getStringCellValue();
				String Website = celldata.getCell(19).getStringCellValue();
				String Interval = celldata.getCell(19).getStringCellValue();
				...
				WebElement type15 = driver.findElement(By.xpath("//select[@aria-label='Account Type']"));
				...
				driver.findElement(By.xpath("(//input[@aria-label='Email'])[2]")).sendKeys(Email1);
				
				driver.findElement(By.xpath("//input[@class='addressAutocomplete']")).clear();
				driver.findElement(By.xpath("//input[@class='addressAutocomplete']")).sendKeys(Address);
				
				driver.findElement(By.xpath("//input[@aria-label='Apartment/Suite number']")).clear();
				driver.findElement(By.xpath("//input[@aria-label='Apartment/Suite number']")).sendKeys(Apartment);
				...
				driver.findElement(By.xpath("//input[@aria-label='Website']")).clear();
...
//				act2.sendKeys(Keys.ENTER).perform();
			    ...
			    WebElement type16 = driver.findElement(By.xpath("//select[@aria-label='Frequency']"));
				org.openqa.selenium.support.ui.Select s16=new org.openqa.selenium.support.ui.Select(type16);
		    	s16.selectByIndex(2);
			    
		    	driver.findElement(By.xpath("//input[@data-id='header_process_av_interval.fieldControl-whole-number-text-input']")).clear();
				driver.findElement(By.xpath("//input[@data-id='header_process_av_interval.fieldControl-whole-number-text-input']")).sendKeys(Interval);
