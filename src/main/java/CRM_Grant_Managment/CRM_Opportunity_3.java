...
public class CRM_Opportunity_3
{
	...
	@FindBy(xpath ="//input[@aria-label='Date of Introductory Meeting']")private WebElement DateofIntroductory;
	   ...
	   @FindBy(xpath ="//input[@aria-label='Fair Market Value']") private WebElement FairMarketValue;
	   @FindBy(xpath ="//textarea[@aria-label='In-Kind Donation Description']") private WebElement InKindDonationDescription;
//    @FindBy(xpath ="//input[@data-id='header_process_av_interval.fieldControl-whole-number-text-input']") private WebElement Interval; 
	...
	public CRM_Opportunity_3 (WebDriver driver)
	{
...
//		act.sendKeys(Keys.ARROW_DOWN).perform();
	...
	//NEW
	public void setCRMFairMarketValue(String marketvalue)
	{
		FairMarketValue.sendKeys(marketvalue);
	}
	public void setCRMInKindDonationDescription(String donationdes)
	{
		InKindDonationDescription.sendKeys(donationdes);
	}
	//CLOSED
//	public void clickonFrequency(WebDriver driver)					
//	{
//		WebElement type = driver.findElement(By.xpath("//select[@aria-label='Frequency']"));
//		org.openqa.selenium.support.ui.Select s=new org.openqa.selenium.support.ui.Select(type);
//	s.selectByIndex(2);
//	}
//	public void setCRmInterval(String interval)
//	{
//		Interval.sendKeys(interval);
//	}
	public void clickonInKindDonationType(WebDriver driver)					
	{
