...
public class CRM_Prospect_Page1
{
...
//  @FindBy(xpath ="(//button[@role='switch'])[1]") private WebElement clickonContact;
	...
	public CRM_Prospect_Page1 (WebDriver driver)
	{
		PageFactory.initElements(driver, this);
	}
	
	public void clickonFunddevelopmentProspectpage1(WebDriver driver)
	{
		driver.switchTo().frame("AppLandingPage");
		clickFunddevelopment.click();
	}
	
	public void clickonprospectpage1() 
	{
		clickonprospect.click();
	}
	
	public void clickonnewprospectpage1() 
	{
		clickonNew.click();
	}
	public void clickonpotentialTypeProspectpage1(WebDriver driver) 
	{
...
//		s.selectByIndex(1);
	...
	public void clickonindividualprospectpage1() 
	{
		clickonindividual.click();
	}
	
	public void setCRMProspectpage1(String est)
	{
		estimated.clear();
		estimated.sendKeys(est);
	}
	public void setCRMProspectpage1date(String username)
	{
		date.sendKeys("10/25/2022");
	}
	public void clickonsourceprospectpage1(WebDriver driver)
	{
...
//	s.selectByIndex(2);
//	}
	public void setCRMProspectpage1fname(String Fname) throws InterruptedException
	{
	...
	public void setCRMProspectpage1lname(String Lname) throws InterruptedException
	{
	...
	public void setCRMPositionTitleprospectpage1(String Ptitle)
	{
		PositionTitle.clear();
		PositionTitle.sendKeys(Ptitle);
	}
	
	public void setCRMProspectpage1Emailid(String EID) throws InterruptedException
	{
	...
	public void setCRMProspectpage1BusinessPhone(String BPhone)
	{
		BusinessPhone.clear();
		BusinessPhone.sendKeys(BPhone);
	}
	
	public void setCRMProspectpage1BusinessPhoneeXT(String BPhoneExt)
	{
		BusinessPhoneExt.clear();
		BusinessPhoneExt.sendKeys(BPhoneExt);
	}
	
	public void setCRMProspectpage1Mobilephone(String Mphone)
	{
		Mobilephone.clear();
		Mobilephone.sendKeys(Mphone);
	}
	
	public void setCRMprospectypage1cause(String username) throws InterruptedException
	{
...
//		s.selectByIndex(1);
	...
	public void clickonsaveprospectpage1()
	{
		clickonsave.click();
	}
	public void clickonqualifyprospectpage1()
	{
		clickonqualify.click();
	}
	public void clickonpopupprospectpage1()
	{
		clickonpopup.click();
	}
