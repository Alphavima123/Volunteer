...
public class DonorLoginPage1_2 
{
//1
...
//2	
	public DonorLoginPage1_2 (WebDriver driver)
	{
...
//	3
	...
	{
		WebElement type = driver.findElement(By.xpath("//select[@class='required border border-danger']"));
