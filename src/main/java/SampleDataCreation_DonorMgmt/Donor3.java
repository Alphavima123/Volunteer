...
public class Donor3
{
	...
	@Test
	public void RunDonor3() throws IOException, InterruptedException
	{
		...
		WebDriver driver=new ChromeDriver();
		 ...
		 driver.findElement(By.xpath("//input[@type='button']")).click();
			...
			for(int i=1;i<=rowcount;i++)
			{
				...
				driver.findElement(By.xpath("//label[text()='Recurring']")).click();
						
				driver.findElement(By.xpath("//button[@title='Close']")).click();
				driver.findElement(By.xpath("//label[text()='In Kind']")).click();
				
				driver.findElement(By.xpath("//input[@aria-label='Fair Market Value']")).clear();
				driver.findElement(By.xpath("//input[@aria-label='Fair Market Value']")).sendKeys(FairMarketValue);
				...
				WebElement type3 = driver.findElement(By.xpath("//select[@aria-label='Ask Readiness']"));
				...
				WebElement type8 = driver.findElement(By.xpath("//select[@id='optionsetStatusReason']"));
