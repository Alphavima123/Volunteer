...
public class DonorLoginPage2_6
{
//1
...
//2	
	public DonorLoginPage2_6 (WebDriver driver)
	{
		PageFactory.initElements(driver, this);
	}

//	3
	public void clickDonorLoginPage2_6Dmonthly() {
		DonateMonthly.click();	
	}
	public void clickDonorLoginPage2D_6Amount() {
		DonationAmount.click();	
	}
	public void clickDonorLoginPage2_6Next() {
		Next.click();
	}
	public void clickDonorLoginPage2_6CFund() {
		CauseFund.click();
	}
	...
	public void clickDonorLoginPage2_6Next2() {
		Next2.click();
	}
	
	public void setDonorLoginPage2_6Fname(String Fname) {
		ContactInfo_Fname.sendKeys(Fname);
	}
	public void setDonorLoginPage2_6Lname(String Lname) {
		ContactInfo_lname.sendKeys(Lname);
	}
	
	public void setDonorLoginPage2_6Email(String Email) {
		ContactInfo_Email.sendKeys(Email);
	}
	public void setDonorLoginPage2_6Number(String Phoneno) {
		ContactInfo_phoneno.sendKeys(Phoneno);
	}
	public void setDonorLoginPage2_6Birthday() {
		Birthday.sendKeys("12/03/1984");
	}
	public void setDonorLoginPage2_6Address(String Adress) {
		Address_Eadd.sendKeys(Adress);
	}
	public void setDonorLoginPage2_6Address1(String Adress1) {
		Address1_Eadd1.sendKeys(Adress1);
	}
	public void setDonorLoginPage2_6Address2(String Adress2) {
		Address1_Eadd1.sendKeys(Adress2);
	}
	public void setDonorLoginPage2_6City(String City) {
		Address_Ecity.sendKeys(City);
	}
	public void setDonorLoginPage2_6country(String Country) {
		Address_Ecountry.sendKeys(Country);
	}
	public void setDonorLoginPage2_6State(String State) {
		Address_Estate.sendKeys(State);
	}
	public void setDonorLoginPage2_6code(String Postalcode) {
		Address_postalcode.sendKeys(Postalcode);
	}
	public void setDonorLoginPage2_6card(String cardno) 
	{
	...
	public void setDonorLoginPage2_6cvv(String cvvNo)
	{
		CardDetails_cardcvv.sendKeys(cvvNo);
	}
	public void clickDonorLoginPage2_6finish() {
		Finish.click();
	}
