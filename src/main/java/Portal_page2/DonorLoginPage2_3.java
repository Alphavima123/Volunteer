...
public class DonorLoginPage2_3
{
//1
...
//2	
	public DonorLoginPage2_3 (WebDriver driver)
	{
		PageFactory.initElements(driver, this);
	}

//	3
	public void clickDonorLoginPage2_3DNow() {
		DonateNow.click();	
	}
	public void clickDonorLoginPage2_3DAmount() {
		DonationAmount.click();	
	}
	public void clickDonorLoginPage2_3Next() {
		Next.click();
	}
	public void clickDonorLoginPage2_3Fund() {
		Fund.click();
	}
	...
	public void clickDonorLoginPage2_3Next2() {
		Next2.click();
	}
	
	public void setDonorLoginPage2_3Fname(String Fname) {
		ContactInfo_Fname.sendKeys(Fname);
	}
	public void setDonorLoginPage2_3Lname(String Lname) {
		ContactInfo_lname.sendKeys(Lname);
	}
	
	public void setDonorLoginPage2_3Email(String Email) {
		ContactInfo_Email.sendKeys(Email);
	}
	public void setDonorLoginPage2_3Number(String Phoneno) {
		ContactInfo_phoneno.sendKeys(Phoneno);
	}
	public void setDonorLoginPage2_3Birthday() {
		Birthday.sendKeys("12/03/1984");
	}
	public void setDonorLoginPage2_3Address(String Adress) {
		Address_Eadd.sendKeys(Adress);
	}
	public void setDonorLoginPage2_3Address1(String Adress1) {
		Address1_Eadd1.sendKeys(Adress1);
	}
	public void setDonorLoginPage2_3Address2(String Adress2) {
		Address1_Eadd1.sendKeys(Adress2);
	}
	public void setDonorLoginPage2_3City(String City) {
		Address_Ecity.sendKeys(City);
	}
	public void setDonorLoginPage2_3country(String Country) {
		Address_Ecountry.sendKeys(Country);
	}
	public void setDonorLoginPage2_3State(String State) {
		Address_Estate.sendKeys(State);
	}
	public void setDonorLoginPage2_3code(String Postalcode) {
		Address_postalcode.sendKeys(Postalcode);
	}
	public void setDonorLoginPage2_3card(String cardno) 
	{
	...
	public void setDonorLoginPage2_3cvv(String cvvNo)
	{
		CardDetails_cardcvv.sendKeys(cvvNo);
	}
	public void clickDonorLoginPage2_3finish() {
		Finish.click();
	}
