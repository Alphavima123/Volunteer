...
//2	
	public DonorLoginPage2 (WebDriver driver)
	{
		PageFactory.initElements(driver, this);
	}

//	3
	public void clickDonorLoginPage2DNow() {
		DonateNow.click();	
	}
	public void clickDonorLoginPage2DAmount() {
		DonationAmount.click();	
	}
	public void clickDonorLoginPage2Next() {
		Next.click();
	}
	public void clickDonorLoginPage2CFund() {
		CauseFund.click();
	}
	...
	public void clickDonorLoginPage2Next2() {
		Next2.click();
	}
	
	public void setDonorLoginPage2Fname(String Fname) {
		ContactInfo_Fname.sendKeys(Fname);
	}
	public void setDonorLoginPage2Lname(String Lname) {
		ContactInfo_lname.sendKeys(Lname);
	}
	
	public void setDonorLoginPage2Email(String Email) {
		ContactInfo_Email.sendKeys(Email);
	}
	public void setDonorLoginPage2Number(String Phoneno) {
		ContactInfo_phoneno.sendKeys(Phoneno);
	}
	public void setDonorLoginPage2Birthday() {
		Birthday.sendKeys("12/03/1984");
	}
	
	
	
	public void setDonorLoginPage2Address(String Adress) {
		Address_Eadd.sendKeys(Adress);
	}
	public void setDonorLoginPage2Address1(String Adress1) {
		Address1_Eadd1.sendKeys(Adress1);
	}
	public void setDonorLoginPage2Address2(String Adress2) {
		Address1_Eadd1.sendKeys(Adress2);
	}
	public void setDonorLoginPage2City(String City) {
		Address_Ecity.sendKeys(City);
	}
	public void setDonorLoginPage2country(String Country) {
		Address_Ecountry.sendKeys(Country);
	}
	public void setDonorLoginPage2State(String State) {
		Address_Estate.sendKeys(State);
	}
	public void setDonorLoginPage2code(String Postalcode) {
		Address_postalcode.sendKeys(Postalcode);
	}
	public void setDonorLoginPage2card(String cardno) 
	{
	...
	public void setDonorLoginPage2cvv(String cvvNo)
	{
		CardDetails_cardcvv.sendKeys(cvvNo);
	}
	public void clickDonorLoginPage2finish() {
		Finish.click();
	}
