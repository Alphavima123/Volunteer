...
public class DonorLoginPage2_11
{
//1
...
//2	
	public DonorLoginPage2_11 (WebDriver driver)
	{
		PageFactory.initElements(driver, this);
	}

//	3
	public void clickDonorLoginPage2_11Dmonthly() {
		Donatemonthly.click();	
	}
	public void clickDonorLoginPage2_11DAmount() {
		DonationAmount.click();	
	}
	public void clickDonorLoginPage2_11Next() {
		Next.click();
	}
	public void clickDonorLoginPage2_11Fund() {
		Fund.click();
	}
	...
	public void clickDonorLoginPage2_11tgift() {
		Tributegift.click();
	}
	...
	public void setDonorLoginPage2_11Tname(String tname) {
		TributeName.sendKeys(tname);
	}
	public void clickDonorLoginPage2_11Next2() {
		Next2.click();
	}
	public void clickDonorLoginPage2_11Binfo() {
		Businessinfo.click();
	}
	public void setDonorLoginPage2_11Bname(String bname) {
		BusinessName.sendKeys(bname);
	}
	public void setDonorLoginPage2_11BPhoneno(String bphoneno) {
		BusinessPhoneno.sendKeys(bphoneno);
	}
	public void setDonorLoginPage2_11Fname(String Fname) {
		ContactInfo_Fname.sendKeys(Fname);
	}
	public void setDonorLoginPage2_11Lname(String Lname) {
		ContactInfo_lname.sendKeys(Lname);
	}
	
	public void setDonorLoginPage2_11Email(String Email) {
		ContactInfo_Email.sendKeys(Email);
	}
	public void setDonorLoginPage2_11Number(String Phoneno) {
		ContactInfo_phoneno.sendKeys(Phoneno);
	}
	public void setDonorLoginPage2_11Birthday() {
		Birthday.sendKeys("12/03/1984");
	}
	
	public void setDonorLoginPage2_11Address(String Adress) {
		Address_Eadd.sendKeys(Adress);
	}
	public void setDonorLoginPage2_11Address1(String Adress1) {
		Address1_Eadd1.sendKeys(Adress1);
	}
	public void setDonorLoginPage2_11Address2(String Adress2) {
		Address1_Eadd1.sendKeys(Adress2);
	}
	public void setDonorLoginPage2_11City(String City) {
		Address_Ecity.sendKeys(City);
	}
	public void setDonorLoginPage2_11country(String Country) {
		Address_Ecountry.sendKeys(Country);
	}
	public void setDonorLoginPage2_11State(String State) {
		Address_Estate.sendKeys(State);
	}
	public void setDonorLoginPage2_11code(String Postalcode) {
		Address_postalcode.sendKeys(Postalcode);
	}
	public void setDonorLoginPage2_11card(String cardno) 
	{
	...
	public void setDonorLoginPage2_11cvv(String cvvNo)
	{
		CardDetails_cardcvv.sendKeys(cvvNo);
	}
	public void clickDonorLoginPage2_11publishno() {
		PublishNo.click();
	}
	public void clickDonorLoginPage2_11finish() {
		Finish.click();
	}
