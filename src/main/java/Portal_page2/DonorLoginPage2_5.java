...
public class DonorLoginPage2_5
{
//1
...
//2	
	public DonorLoginPage2_5 (WebDriver driver)
	{
		PageFactory.initElements(driver, this);
	}

//	3
	public void clickDonorLoginPage2_5DNow() {
		DonateNow.click();	
	}
	public void clickDonorLoginPage2_5DAmount() {
		DonationAmount.click();	
	}
	public void clickDonorLoginPage2_5Next() {
		Next.click();
	}
	public void clickDonorLoginPage2_5Fund() {
		Fund.click();
	}
	...
	public void clickDonorLoginPage2_5tgift() {
		Tributegift.click();
	}
	...
	public void setDonorLoginPage2_5Tname(String tname) {
		TributeName.sendKeys(tname);
	}
	public void clickDonorLoginPage2_5Next2() {
		Next2.click();
	}
	public void clickDonorLoginPage2_5Binfo() {
		Businessinfo.click();
	}
	public void setDonorLoginPage2_5Bname(String bname) {
		BusinessName.sendKeys(bname);
	}
	public void setDonorLoginPage2_5BPhoneno(String bphoneno) {
		BusinessPhoneno.sendKeys(bphoneno);
	}
	public void setDonorLoginPage2_5Fname(String Fname) {
		ContactInfo_Fname.sendKeys(Fname);
	}
	public void setDonorLoginPage2_5Lname(String Lname) {
		ContactInfo_lname.sendKeys(Lname);
	}
	
	public void setDonorLoginPage2_5Email(String Email) {
		ContactInfo_Email.sendKeys(Email);
	}
	public void setDonorLoginPage2_5Number(String Phoneno) {
		ContactInfo_phoneno.sendKeys(Phoneno);
	}
	public void setDonorLoginPage2_5Birthday() {
		Birthday.sendKeys("12/03/1984");
	}
	
	public void setDonorLoginPage2_5Address(String Adress) {
		Address_Eadd.sendKeys(Adress);
	}
	public void setDonorLoginPage2_5Address1(String Adress1) {
		Address1_Eadd1.sendKeys(Adress1);
	}
	public void setDonorLoginPage2_5Address2(String Adress2) {
		Address1_Eadd1.sendKeys(Adress2);
	}
	public void setDonorLoginPage2_5City(String City) {
		Address_Ecity.sendKeys(City);
	}
	public void setDonorLoginPage2_5country(String Country) {
		Address_Ecountry.sendKeys(Country);
	}
	public void setDonorLoginPage2_5State(String State) {
		Address_Estate.sendKeys(State);
	}
	public void setDonorLoginPage2_5code(String Postalcode) {
		Address_postalcode.sendKeys(Postalcode);
	}
	public void setDonorLoginPage2_5card(String cardno) 
	{
	...
	public void setDonorLoginPage2_5cvv(String cvvNo)
	{
		CardDetails_cardcvv.sendKeys(cvvNo);
	}
	public void clickDonorLoginPage2_5publishno() {
		PublishNo.click();
	}
	public void clickDonorLoginPage2_5finish() {
		Finish.click();
	}
