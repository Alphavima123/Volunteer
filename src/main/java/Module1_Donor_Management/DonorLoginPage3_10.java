...
public class DonorLoginPage3_10
{
	...
	public DonorLoginPage3_10 (WebDriver driver)
	{
		PageFactory.initElements(driver, this);
	}
	
	public void clickDonorLoginPage3_10DMonthly() {
		DonateMonthly.click();	
	}
	public void clickDonorLoginPage3_10DAmount() {
		DonateAmount.click();	
	}
	public void clickDonorLoginPage3_10Next() {
		Next.click();
	}
	public void clickDonorLoginPage3_10fund() {
		Fund.click();
	}
	...
	public void clickDonorLoginPage3_10tgift() {
		Tributegift.click();
	}
	...
	public void setDonorLoginPage3_10Tname(String tname) {
		TributeName.sendKeys(tname);
	}
	public void clickDonorLoginPage3_10Next2() {
		Next2.click();
	}
	public void setDonorLoginPage3_10Fname(String fname) {
		Fname.sendKeys(fname);
	}
	public void setDonorLoginPage3_10Lname(String lname) {
		Lname.sendKeys(lname);
	}
	
	public void setDonorLoginPage3_10Email(String email) {
		Email.sendKeys(email);
	}
	
	public void setDonorLoginPage3_10pNumber(String phoneno) {
		Phoneno.sendKeys(phoneno);
	}
	public void setDonorLoginPage3_10Birthday() {
		Birthday.sendKeys("12/03/1984");
	}
	public void setDonorLoginPage3_10Address(String adress) {
		Adress.sendKeys(adress);
	}
	public void setDonorLoginPage3_10Address1(String Adress1) {
		Adressline1.sendKeys(Adress1);
	}
	public void setDonorLoginPage3_10Address2(String Adress2) {
		Adressline2.sendKeys(Adress2);
	}
	public void setDonorLoginPage3_10City(String city) {
		City.sendKeys(city);
	}
	public void setDonorLoginPage3_10country(String country) {
		Country.sendKeys(country);
	}
	public void setDonorLoginPage3_10State(String state) {
		State.sendKeys(state);
	}
	public void setDonorLoginPage3_10code(String postalcode) {
		Postalcode.sendKeys(postalcode);
	}
	public void setDonorLoginPage3_10card(String cardno) 
	{
	...
	public void setDonorLoginPage3_10cvv(String cvvNo)
	{
		CardCVV.sendKeys(cvvNo);
	}
	public void clickDonorLoginPage3_10Finish() {
		Finish.click();
	}
}
