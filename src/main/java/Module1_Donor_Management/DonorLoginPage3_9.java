...
public class DonorLoginPage3_9
{
	...
	@FindBy(xpath="//label[@for='nopublic']") private WebElement NOPublic;
	@FindBy(xpath="//a[@href='#finish']") private WebElement Finish;
	
	public DonorLoginPage3_9 (WebDriver driver)
	{
		PageFactory.initElements(driver, this);
	}
	
	public void clickDonorLoginPage3_9DMonthly() {
		DonateMonthly.click();	
	}
	public void clickDonorLoginPage3_9DAmount() {
		DonateAmount.click();	
	}
	public void clickDonorLoginPage3_9Next() {
		Next.click();
	}
	public void clickDonorLoginPage3_9fund() {
		Fund.click();
	}
	...
	public void clickDonorLoginPage3_9Next2() {
		Next2.click();
	}
	public void setDonorLoginPage3_9Fname(String fname) {
		Fname.sendKeys(fname);
	}
	public void setDonorLoginPage3_9Lname(String lname) {
		Lname.sendKeys(lname);
	}
	
	public void setDonorLoginPage3_9Email(String email) {
		Email.sendKeys(email);
	}
	
	public void setDonorLoginPage3_9pNumber(String phoneno) {
		Phoneno.sendKeys(phoneno);
	}
	public void setDonorLoginPage3_9Birthday() {
		Birthday.sendKeys("12/03/1984");
	}
	public void setDonorLoginPage3_9Address(String adress) {
		Adress.sendKeys(adress);
	}
	public void setDonorLoginPage3_9Address1(String Adress1) {
		Adressline1.sendKeys(Adress1);
	}
	public void setDonorLoginPage3_9Address2(String Adress2) {
		Adressline2.sendKeys(Adress2);
	}
	public void setDonorLoginPage3_9City(String city) {
		City.sendKeys(city);
	}
	public void setDonorLoginPage3_9country(String country) {
		Country.sendKeys(country);
	}
	public void setDonorLoginPage3_9State(String state) {
		State.sendKeys(state);
	}
	public void setDonorLoginPage3_9code(String postalcode) {
		Postalcode.sendKeys(postalcode);
	}
	public void setDonorLoginPage3_9card(String cardno) 
	{
	...
	public void setDonorLoginPage3_9cvv(String cvvNo)
	{
		CardCVV.sendKeys(cvvNo);
	}
	public void clickDonorLoginPage3_9nopublic() {
		NOPublic.click();
	}
	
	public void clickDonorLoginPage3_9Finish() {
		Finish.click();
	}
}
