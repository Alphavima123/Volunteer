...
public class CRM_Test_Class_1 extends Baseclass
{
	CRM_login1_page login1;
	CRM_login2_page login2;
	CRM_Prospect_1 prospect;
	CRM_Opportunity_1 Opportunity;
	...
	public void OpentheBrowser() throws IOException
	{
		...
		prospect=new CRM_Prospect_1(driver);
		Opportunity=new CRM_Opportunity_1(driver);	
	}
