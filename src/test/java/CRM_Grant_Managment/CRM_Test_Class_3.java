...
public class CRM_Test_Class_3 extends Baseclass
{
	CRM_login1_page login1;
	CRM_login2_page login2;
	CRM_Prospect_3 prospect;
	CRM_Opportunity_3 Opportunity;
	...
	public void OpentheBrowser() throws IOException
	{
		...
		prospect=new CRM_Prospect_3(driver);
		Opportunity=new CRM_Opportunity_3(driver);
	...
	public void LoginToAap() throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		Thread.sleep(1500);
		prospect.clickonExistingContact();
		Thread.sleep(1500);
...
//		prospect.setCRMProspectpageMobilephone(Utilityclass_CRM_page.getTD(1, 9));
		...
		Thread.sleep(1500);
		prospect.clickonExistingOrganization();
		prospect.clickonSelectOrganization(driver);
...
//		prospect.setCRMopportunityWebsite(Utilityclass_CRM_page.getTD(1, 35));
	...
	//	Opportunity.clickonAccount(driver);
		...
		Thread.sleep(1500);
		Opportunity.setCRMFairMarketValue(Utilityclass_CRM_page.getTD(1, 37));
		Thread.sleep(1500);
		Opportunity.setCRMInKindDonationDescription(Utilityclass_CRM_page.getTD(1, 38));
		Thread.sleep(1500);
