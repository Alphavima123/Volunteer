...
import Module1_Donor_Management.DonorLoginPage1_7;

public class Donor_TESTCASE1_7 extends Baseclass_Portal_page
{

	DonorLoginPage1_7 login;
	Sheet sh;
	int TestcaseID;
	...
	//	DonorLoginPage login=new DonorLoginPage(driver);                  // Wrong way
	 login=new DonorLoginPage1_7(driver);										// right way
...
//	@Test(priority = 2)
	...
	public void FillInfo() throws EncryptedDocumentException, IOException
	{
    	...
    	login.clickDonorLoginPageTgift();
    	login.clickonmemoryof(driver);
    	login.setDonorLoginPageTributename(Utilityclass.getTD(1, 16));
    	login.clickDonorLoginPagecompanyinfo();
    	login.setDonorLoginPageCompanyname(Utilityclass.getTD(1, 4));
    	login.setDonorLoginPageBusinessphoneno(Utilityclass.getTD(1, 5));
