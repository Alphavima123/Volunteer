...
import Module1_Donor_Management.DonorLoginPage1_9;

public class Donor_TESTCASE1_9 extends Baseclass_Portal_page
{

	DonorLoginPage1_9 login;
	Sheet sh;
	int TestcaseID;
	...
	//	DonorLoginPage login=new DonorLoginPage(driver);                  // Wrong way
	 login=new DonorLoginPage1_9(driver);										// right way
