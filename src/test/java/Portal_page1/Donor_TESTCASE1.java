...
import Module1_Donor_Management.DonorLoginPage1;

public class Donor_TESTCASE1 extends Baseclass_Portal_page
{

	DonorLoginPage1 login;
	Sheet sh;
	int TestcaseID;
	...
	//	DonorLoginPage login=new DonorLoginPage(driver);                  // Wrong way
	 login=new DonorLoginPage1(driver);										// right way
