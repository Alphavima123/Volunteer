...
import Module1_Donor_Management.DonorLoginPage1_3;

public class Donor_TESTCASE1_3 extends Baseclass_Portal_page
{

	DonorLoginPage1_3 login;
	Sheet sh;
	int TestcaseID;
	...
	//	DonorLoginPage login=new DonorLoginPage(driver);                  // Wrong way
	 login=new DonorLoginPage1_3(driver);										// right way
