...
import Module1_Donor_Management.DonorLoginPage1_6;

public class Donor_TESTCASE1_6 extends Baseclass_Portal_page
{

	DonorLoginPage1_6 login;
	Sheet sh;
	int TestcaseID;
	...
	//	DonorLoginPage login=new DonorLoginPage(driver);                  // Wrong way
	 login=new DonorLoginPage1_6(driver);										// right way
