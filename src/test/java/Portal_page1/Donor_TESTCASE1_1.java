...
import Module1_Donor_Management.DonorLoginPage1_1;

public class Donor_TESTCASE1_1 extends Baseclass_Portal_page
{

	DonorLoginPage1_1 login;
	Sheet sh;
	int TestcaseID;
	...
	//	DonorLoginPage login=new DonorLoginPage(driver);                  // Wrong way
	 login=new DonorLoginPage1_1(driver);										// right way
