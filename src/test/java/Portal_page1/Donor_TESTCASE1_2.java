...
import Module1_Donor_Management.DonorLoginPage1_2;

public class Donor_TESTCASE1_2  extends Baseclass_Portal_page
{

	DonorLoginPage1_2 login;
	Sheet sh;
	int TestcaseID;
	...
	//	DonorLoginPage login=new DonorLoginPage(driver);                  // Wrong way
	 login=new DonorLoginPage1_2(driver);										// right way
