...
import Module1_Donor_Management.DonorLoginPage1_8;

public class Donor_TESTCASE1_8  extends Baseclass_Portal_page
{

	DonorLoginPage1_8 login;
	Sheet sh;
	int TestcaseID;
	...
	//	DonorLoginPage login=new DonorLoginPage(driver);                  // Wrong way
	 login=new DonorLoginPage1_8(driver);										// right way
