...
import Module1_Donor_Management.DonorLoginPage1_4;

public class Donor_TESTCASE1_4 extends Baseclass_Portal_page
{

	DonorLoginPage1_4 login;
	Sheet sh;
	int TestcaseID;
	...
	//	DonorLoginPage login=new DonorLoginPage(driver);                  // Wrong way
	 login=new DonorLoginPage1_4(driver);										// right way
