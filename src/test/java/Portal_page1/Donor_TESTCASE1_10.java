...
import Module1_Donor_Management.DonorLoginPage1_10;

public class Donor_TESTCASE1_10 extends Baseclass_Portal_page
{

	DonorLoginPage1_10 login;
	Sheet sh;
	int TestcaseID;
	...
	//	DonorLoginPage login=new DonorLoginPage(driver);                  // Wrong way
	 login=new DonorLoginPage1_10(driver);										// right way
