...
public class Donor_TESTCASE_page3_1 extends Baseclass_Portal_page3
{
...
//	@Test(priority = 2)
	...
	public void FillInfo() throws EncryptedDocumentException, IOException
	{
		...
		login.setDonorLoginPage3_1Tname(UtilityclassPortalpage3.getTD(1, 17));
...
//		login.setDonorLoginPage3Birthday(UtilityclassPortalpage3.getTD(1, 4));
		...
		login.setDonorLoginPage3_1Address(UtilityclassPortalpage3.getTD(1, 8));
		login.setDonorLoginPage3_1Address1(UtilityclassPortalpage3.getTD(1, 9));
		login.setDonorLoginPage3_1Address2(UtilityclassPortalpage3.getTD(1, 10));
		login.setDonorLoginPage3_1City(UtilityclassPortalpage3.getTD(1, 11));
		login.setDonorLoginPage3_1country(UtilityclassPortalpage3.getTD(1, 12));
		login.setDonorLoginPage3_1State(UtilityclassPortalpage3.getTD(1, 13));
		login.setDonorLoginPage3_1code(UtilityclassPortalpage3.getTD(1, 14));
		login.setDonorLoginPage3_1card(UtilityclassPortalpage3.getTD(1, 15));
		login.clickonyear(driver);
		login.clickonmonth(driver);
		login.setDonorLoginPage3_1cvv(UtilityclassPortalpage3.getTD(1, 16));
