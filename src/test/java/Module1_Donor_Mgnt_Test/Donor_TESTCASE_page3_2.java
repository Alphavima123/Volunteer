...
//	@Test(priority = 2)
	...
	public void FillInfo() throws EncryptedDocumentException, IOException
	{
		...
		login.setDonorLoginPage3_2Tname(UtilityclassPortalpage3.getTD(1, 16));
		login.clickDonorLoginPage3_2Next2();
		login.clickDonorLoginPage3_2Binfo();
		login.setDonorLoginPage3_2Bname(UtilityclassPortalpage3.getTD(1, 4));
		login.setDonorLoginPage3_2BPhoneno(UtilityclassPortalpage3.getTD(1, 5));
...
//		login.setDonorLoginPage3Birthday(UtilityclassPortalpage3.getTD(1, 4));
		...
		login.setDonorLoginPage3_2Address(UtilityclassPortalpage3.getTD(1, 7));
		login.setDonorLoginPage3_2Address1(UtilityclassPortalpage3.getTD(1, 8));
		login.setDonorLoginPage3_2Address2(UtilityclassPortalpage3.getTD(1, 9));
		login.setDonorLoginPage3_2City(UtilityclassPortalpage3.getTD(1, 10));
		login.setDonorLoginPage3_2country(UtilityclassPortalpage3.getTD(1, 11));
		login.setDonorLoginPage3_2State(UtilityclassPortalpage3.getTD(1, 12));
		login.setDonorLoginPage3_2code(UtilityclassPortalpage3.getTD(1, 13));
		login.setDonorLoginPage3_2card(UtilityclassPortalpage3.getTD(1, 14));
		login.clickonyear(driver);
		login.clickonmonth(driver);
		login.setDonorLoginPage3_2cvv(UtilityclassPortalpage3.getTD(1, 15));
