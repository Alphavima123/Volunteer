...
//		login.setDonorLoginPage3Birthday(UtilityclassPortalpage3.getTD(1, 4));
		...
		login.setDonorLoginPage3_6Address(UtilityclassPortalpage3.getTD(1, 7));
		login.setDonorLoginPage3_6Address1(UtilityclassPortalpage3.getTD(1, 8));
		login.setDonorLoginPage3_6Address2(UtilityclassPortalpage3.getTD(1, 9));
		login.setDonorLoginPage3_6City(UtilityclassPortalpage3.getTD(1, 10));
		login.setDonorLoginPage3_6country(UtilityclassPortalpage3.getTD(1, 11));
		login.setDonorLoginPage3_6State(UtilityclassPortalpage3.getTD(1, 12));
		login.setDonorLoginPage3_6code(UtilityclassPortalpage3.getTD(1, 13));
		login.setDonorLoginPage3_6card(UtilityclassPortalpage3.getTD(1, 14));
		login.clickonyear(driver);
		login.clickonmonth(driver);
		login.setDonorLoginPage3_6cvv(UtilityclassPortalpage3.getTD(1, 15));
